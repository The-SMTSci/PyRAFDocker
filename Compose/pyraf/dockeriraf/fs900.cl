#############################################################################
# fs900.cl header data to add site and instrument information to fits header
#############################################################################
...
nhedit @l.l LONGITUD      70.764941                 "Site Longitude [deg]"                   add+ update+ del- ver- show-
...
nhedit @l.l INSTRUME     'FS900/QHY268M'            "Instrument Description"                 add+ update+ del- ver- show-
...
nhedit @l.l RDNOISE      '1'                        "Place holder for RDNOISE"               add+ update+ del- ver- show-
nhedit @l.l CMOSMODE     'Mode1_High_Gain'          "QHY Mode 1"                             add+ update+ del- ver- show-

nhedit @l.l GAIN         1                          "Override GAIN for IRAF tasks"           add+ update+ del- ver- show-
nhedit @l.l RDNOISE      '1'                        "Place holder for RDNOISE"               add+ update+ del- ver- show-
nhedit @l.l GAIN         1                          "Override GAIN for IRAF tasks"           add+ update+ del- ver- show-
...
nhedit @l.l GRATING      900                        "Grating [lines/mm]"                     add+ update+ del- ver- show-
...
nhedit @l.l SPECCFG      'FS900'                    "Spectrograph configuration"             add+ update+ del- ver- show-
